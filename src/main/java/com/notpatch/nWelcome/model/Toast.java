package com.notpatch.nWelcome.model;
...
public final class Toast {
    ...
    private Toast(String icon, String message, Style style) {
        this.key = new NamespacedKey(NWelcome.getInstance(), UUID.randomUUID().toString());
        this.icon = icon;
    ...
    private void start(Player player) {
        ...
        Bukkit.getScheduler().runTaskLater(NWelcome.getInstance(), () -> {
